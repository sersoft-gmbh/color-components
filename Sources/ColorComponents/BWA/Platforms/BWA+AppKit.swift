...
extension NSColorSpace {
    /// The default color space used by `BW` and `BWA` to create `NSColor`s when no color space was specified. This is currently equivalent to `NSColorSpace.deviceGray`.
...
extension NSColor {
    ...
    ///   - colorSpace: The colro space to use. Defaults to `NSColorSpace.colorComponentsDefaultGray`.
    @inlinable
